...
const Home = () => {
  ...
  const getRoomByAreaAndPrice = async () => {
    try {
      setIsSearch(true);
      const result = await roomService.getRoomByAreaAndPrice(
        area[0],
        area[1],
        price[0] * 1000000,
        price[1] * 1000000
  ...
  const onChangePageCity = async (currentPage) => {
    try {
      setIsSearch(false);
      const result = await roomService.getAllRoomByIdCities(
        idCity,
        currentPage
      );
      // console.log(result.data)
      ...
      <Container>
        <Row>
          <Col>
            ...
            >
              <Dropdown
                className="slect-area"
                style={{ color: "#333", marginRight: "5px", minWidth: "260px" }}
                value={selectedCity}
                options={cities}
                onChange={onCityChange}
                optionLabel="namCities"
                optionValue="_id"
              ...
              <Button
                style={{
                  minWidth: "260px",
                  marginTop: "6px",
                  backgroundColor: "#fbc02dc",
                  border: "none",
                }}
                label="Tìm xung quanh"
                icon="pi pi-search"
                iconPos="right"
                ...
                <div className="slider-demo">
                  ...
                  <div>
                    ...
                    <Slider
                      ...
                      onSlideEnd={getRoomByAreaAndPrice}
                      range
                    />
                  </div>
                </div>
        ...
        <Row>
          <Col>
            ...
            >
              <div
                onClick={() => {
                  onClickCity("63437e882399ccdd43ff48ae");
                }}
              >
                <Card
                  className="card-city-detail"
                  title="Hồ Chí Minh"
                  style={{
                    width: "24em",
                    borderRadius: "12px",
              ...
              <div
                onClick={() => {
                  onClickCity("63437e9d2399ccdd43ff48b0");
                }}
              >
                <Card
                  className="card-city-detail"
              ...
              <div
                onClick={() => {
                  onClickCity("63437ed12399ccdd43ff48ba");
                }}
              >
                <Card
                  className="card-city-detail"
        ...
        <Row style={{ marginTop: "20px" }}>
          <Col lg={9}>
            ...
            >
              ...
              {room.length !== 0 ? (
                renderRoom().map((item, index) => (
                  <RoomList key={index} room={item[0]} />
                ))
              ) : (
                <div></div>
              )}
